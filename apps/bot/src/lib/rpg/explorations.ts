...
export const EXPLORES: ExploreOutcome[] = [
  ...
  {
    text: 'Kamu menemukan batang kayu tumbang.',
    coins: 35,
    exp: 10,
    emoji: '🪵',
    rarity: 'Common',
  ...
  {
    text: 'Kamu mengumpulkan batu-batu kecil.',
    coins: 30,
    exp: 8,
    emoji: '🪨',
    rarity: 'Common',
    ...
    item: {
      ...
      sellPrice: 2,
      type: 'material',
      description: 'Batu dasar untuk perkakas',
    },
  },
  {
    text: 'Serat tanaman untuk membuat tali.',
    coins: 25,
    exp: 8,
    emoji: '🧵',
    rarity: 'Common',
    ...
    item: {
      ...
      sellPrice: 4,
      type: 'material',
      description: 'Tali dari serat tumbuhan',
    },
  },
  ...
  {
    text: 'Kamu menemukan urat bijih besi!',
    coins: 80,
    exp: 25,
    emoji: '⛏️',
    rarity: 'Uncommon',
    ...
    item: {
      ...
      sellPrice: 12,
      type: 'material',
      description: 'Bijih besi mentah untuk ditempa',
    },
  },
  {
    text: 'Kilau ungu dari mythril ore!',
    coins: 150,
    exp: 40,
    emoji: '💜',
    rarity: 'Rare',
    ...
    item: {
      ...
      sellPrice: 45,
      type: 'material',
      description: 'Logam langka berkilau ungu',
    },
  },
