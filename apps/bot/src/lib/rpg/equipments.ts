...
export const EQUIPMENTS: Record<string, EquipmentData> = {
  ...
  wooden_rod: {
    ...
    rarity: 'Common',
    sellPrice: 50,
    description: 'Basic fishing rod. +10% rare fish chance',
    stats: { fishBonus: 0.1 },
  },
  iron_rod: {
    id: 'iron_rod',
    ...
    rarity: 'Uncommon',
    sellPrice: 150,
    description: 'Sturdy rod. +20% rare fish chance',
    stats: { fishBonus: 0.2 },
  },
  mythril_rod: {
    id: 'mythril_rod',
    ...
    rarity: 'Rare',
    sellPrice: 400,
    description: 'Gleaming rod. +35% rare fish chance',
  ...
  stone_pickaxe: {
    ...
    rarity: 'Common',
    sellPrice: 40,
    description: 'Basic pickaxe. +10% ore yield',
    stats: { mineBonus: 0.1 },
  },
  iron_pickaxe: {
    id: 'iron_pickaxe',
    ...
    rarity: 'Uncommon',
    sellPrice: 140,
    description: 'Reliable pick. +20% ore yield',
    stats: { mineBonus: 0.2 },
  },
  mythril_pickaxe: {
    id: 'mythril_pickaxe',
  ...
  forager_bag: {
    ...
    rarity: 'Uncommon',
    sellPrice: 120,
    description: 'Extra pockets. +15% gather yield',
